  ...
  <section>
    <div class="register-page">
      <div class="register-asset">
        <img
          src="../assets/undraw_transfer_money_rywa.png"
          alt="register-image"
        />
        <p>
          Send and Receive money instantly to and from anyone with a phone
          number, email address or account number.
        </p>
      </div>
      <div class="register-form">
        ...
        <form id="form" @submit.prevent="signUp">
          ...
          <div class="form-container">
            ...
            <p class="user-existing" v-show="userExist">
...
export default {
  ...
  created() {
    document.title = "Create An Account || Hyper";
  },
};
</script>
